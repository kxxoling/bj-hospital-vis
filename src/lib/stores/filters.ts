...
export const ALL_RANK: string[] = ['全部', '未评级', '三级', '二级', '一级']
export const ALL_CATEGORY: string[] = [
  '全部',
  '对外专科',
  '对外中医',
  '对内',
...
export const NO_NEED_PRE_SELECT_CODE: number[] = [
...
export const NO_NEED_PRE_SELECT_CODE_MAP: Record<number, boolean> =
  NO_NEED_PRE_SELECT_CODE.reduce<Record<number, boolean>>((ret, code) => {
    ret[code] = true
    return ret
  }, {})
